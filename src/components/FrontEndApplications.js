                            ...
                            if(appliction.jobTitle == "Front-End Developer"){
                                return (
                                    <tr key={appliction._id}>
                                        ...
                                        <td><button class="btn btn-info" onClick={()=>{handleView(appliction)}} style={{width:"120px"}}>View Details</button></td>
                                        <td>{appliction.status == "applied" && (<div><button class="btn btn-success" onClick={()=>{handleShorlist(appliction._id)}}>Shortlist</button>||<button class="btn btn-danger" onClick={()=>{handleReject(appliction._id)}} >Reject</button></div>)}
                                        {
